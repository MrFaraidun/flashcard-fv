...
import { register, login } from '../api/apiUser'; // Import the register function from api.js
...
const Register = () => {
    ...
    const { setIsLoggedIn, setUserData } = useUser(); // Access setIsLoggedIn and setUserData from context
