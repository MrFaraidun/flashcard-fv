...
export const UserProvider = ({ children }) => {
        ...
        const fetchUser = async () => {
            try {
                ...
                if (userInfo && userInfo.isLoggedIn) {
                    ...
                    console.log("Profile Picture URL from API:", userInfo.profilePictureUrl);
    ...
    return (
        <UserContext.Provider value={{ isLoggedIn, setIsLoggedIn, userData, setUserData, profilePicture, setProfilePicture }}>
            {children}
