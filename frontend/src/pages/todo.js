        ...
        <div className="flex items-center justify-center min-h-screen mt-6 bg-[#1F2937]">
            <div className="w-full h-full max-w-md bg-[#131c30] shadow-lg rounded-2xl p-6">
                ...
                {completeTasks.length > 0 && (
                    <>
                        <h2 className="text-xl font-bold text-[#facc15] mt-6 mb-2">Completed</h2>
                ...
                {incompleteTasks.length > 0 && (
                    <>
                        <h2 className="text-xl font-bold text-[#facc15] mt-6 mb-2">Incomplete</h2>
                        <ul className="space-y-2">
...
const TaskItem = ({
    ...
    return (
        <li className="flex justify-between items-center max-w-md bg-[#06081fe0] break-words flex-1 text-white p-4 rounded-lg">
            ...
            <div className="ml-2">
                {editId === task.id ? (
                    <button onClick={() => saveEditedTask(task.id)} className="text-white hover:text-[#f59e0b]">
                        <ImCheckmark />
                    </button>
                ) : (
                    <div className="flex space-x-4">
                        <button onClick={() => editTask(task.id)} className="text-white hover:text-[#f59e0b]">
                            <MdEdit className="w-6 h-6" />
                        </button>
                        <button onClick={() => removeTask(task.id)} className="text-white hover:text-[#f59e0b]">
